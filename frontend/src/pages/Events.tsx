          ...
          <div className="group relative bg-gradient-to-br from-purple-900/30 to-black/50 backdrop-blur-sm rounded-3xl overflow-hidden border border-purple-500/30 hover:border-purple-500/60 transition-all duration-500 hover:shadow-2xl hover:shadow-purple-500/30">
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <div className="p-8 md:p-12 flex flex-col justify-center">
                ...
                <button className="px-8 py-4 bg-gradient-to-r from-purple-600 to-pink-600 text-white font-semibold rounded-full hover:scale-105 transition-all duration-300 hover:shadow-xl hover:shadow-purple-500/50 w-fit">
                  Register Now
                </button>
              </div>
            </div>
            ...
            {eventsData.upcoming.map((event, index) => (
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <button className="w-full px-6 py-3 bg-purple-600/20 hover:bg-purple-600 text-purple-300 hover:text-white font-semibold rounded-xl transition-all duration-300 border border-purple-500/30 hover:border-purple-500">
                    Learn More
                  </button>
                </div>
              </div>
